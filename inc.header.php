    ...
    <div class="multiViewTopBanner">
      <div class="navLeft">
        <div class="navButtons">
          ...
          <div class='splitter'></div>
          <a href='javascript:void(0);' class='navButtonExplore'  ><img src='img/nav_globe.png' alt='' /></a> </div>
      </div>
      <div class="navButtons navRight" style="left: 115px;">
        ...
        <div class='splitter'></div>
        <a href='#' class="lfacebook"><img src='img/nav_user.png' alt='Sign in'  /><span>Sign in facebook</span></a>
        <div class='splitter'></div>
        
         <div id="customBtn" class="customGPlusSignIn"><img src='img/nav_user.png' alt='Sign in'  /><span class="icon"></span><span class="buttonText">Sign in google</span></div>
 <!--<div id="customBtn" class="customGPlusSignIn">
    <span class="icon"></span>
    <span class="buttonText">Google</span>
  </div>-->
   <div class='splitter'></div>
   <a href='#' class="ltwitter"><img src='img/nav_user.png' alt='Sign in'  /><span>Sign in twitter</span></a>
  ...
  <div class="explorePopover navPopover">
    <div class="exploreSection"> <a href="/popular" >Popular</a> <a href="/interesting" >Random</a> <a href="/justnow" >Just now</a> </div>
    <div class="exploreSection"> <a class="" href="/Channel/fashion" >Fashion</a> <a class="" href="/Channel/entertainment" >Entertainment</a> <a class="" href="/Channel/food" >Food</a> <a class="" href="/Channel/animal" >Pets</a> <a class="" href="/Channel/art" >Art</a> <a class="" href="/Channel/urban" >Urban</a> <a class="" href="/Channel/nature" >Nature</a> <a class="" href="/Channel/tech" >Tech</a> </div>
  </div>
  ...
  <div id="qrCodeModal" style="z-index: 1090" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-body">
      <div style="height: 150px; position: relative"> <img id="loadingQrCode" style="z-index:1091; position:absolute; top:65px; left:245px;" src="/Content/MultiView/ajax-loader.gif" alt="loading" /> <img id="qrCodeImage" style="z-index: 1092; position: absolute; left: 190px;" src="" alt="QR code" /> </div>
  ...
  <div class="modal hide fade" id="loginFormModal" style="border:none;">
    ...
    <div class="modal-body">
      <div class="loginFormBody">
        <div style="color: #68AABE;"> <i class="icon-info-sign" style="opacity: 0.3; margin-right: 5px;"></i>Sign in to follow other user, post comments and likes. </div>
        <div class="instagramLogin"> <a href="/Account/LoginWithService?serviceType=instagram&amp;redirectUrl=%2F"> <img src="/img/login_instagram_en.png" alt="login instagram" /> </a> </div>
        <div style="color: #68AABE; padding-bottom: 10px; margin-top: 24px; padding-top: 24px; border-top: solid 1px #eee;"> No Instagram account? <a href="http://instagr.am/" target="_blank">Download Instagram and sign up</a> </div>
      </div>
    </div>
  </div>
  <div class="note ">
    <div class="noteContent">
      <div> <a data-toggle="modal" href="/Account/LoginWithService?serviceType=instagram&amp;redirectUrl=%2F" target="_blank"> <img src="/img/pinsta-splash_en.png" alt="pinsta introduction splash" /> </a> </div>
      <div class="hideNoteButtonContainer"> <a class="signInLink" href="/Account/LoginWithService?serviceType=instagram&amp;redirectUrl=%2F" rel="nofollow"> <img src="/img/login_instagram_en.png" alt="login instagram" /> </a> </div>
    </div>
  </div>
...
<div class="middleAdsBannerWrapper">
  <div class="middleAdsBanner underNavBar">
    <div class="adsContentWrapper"> </div>
  </div>
</div>
<div class="likedAlert">
  <div class="likedAlertContent"> <img src="/img/heart.png" alt="" /> </div>
</div>
<div class="pageLoading"> <img src="img/page-load.gif" alt="loading" /> </div>
<div class="mapModeWrapper">
  <div class="mapModeMapView"></div>
  <div style="position:absolute;top:0px; right:0px;">[x]</div>
</div>
